...
export default function LuxuryFleet() {
  ...
  useEffect(() => {
    vehiclesApi
      .list()
      .then((data) => setList(data.filter((v) => v.type === 'luxury')))
  ...
  return (
    <div>
      <PageMeta title="Luxury Fleet" description="Luxury Fleet available for booking with BlackStone Chauffeur." />

      <section className="mx-auto max-w-7xl px-4 py-16 md:px-8">
        <h1 className="font-heading text-4xl text-brand-black">Luxury Fleet</h1>
