...
import {
  ...
  Check, ArrowRight, ShieldCheck, RotateCcw, Headphones, BadgeDollarSign, Plus, X,
} from 'lucide-react'
        ...
        <div className="flex flex-col gap-4 lg:sticky lg:top-24 lg:h-fit">
          ...
          <div className="flex items-start gap-3 border border-black/10 bg-white p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-black/50">
                We include 30 minutes of free waiting time for airport pickups and 15 minutes for all other bookings.
              </p>
            </div>
          </div>
          ...
          {step < 3 && (
            <button
              ...
              className="flex items-center justify-center gap-2 bg-brand-gold px-6 py-3 text-sm font-medium text-brand-black transition-colors hover:bg-brand-champagne disabled:cursor-not-allowed disabled:opacity-40"
            >
